...
const shortcutIconCupRed = 'shortcut_cup_red';
const shortcutIconCupOrange = 'shortcut_cup_orange';
const shortcutIconCupGreen = 'shortcut_cup_green';
const shortcutIconCupBlue = 'shortcut_cup_blue';
const shortcutIconCupPurple = 'shortcut_cup_purple';
const shortcutIconCupBrown = 'shortcut_cup_brown';
const shortcutIconCupPink = 'shortcut_cup_pink';
const shortcutIconCupAmber = 'shortcut_cup_amber';
const shortcutIconCupTeal = 'shortcut_cup_teal';
const shortcutIconCupCyan = 'shortcut_cup_cyan';
const shortcutIconCupLavender = 'shortcut_cup_lavender';
const shortcutIconCupBlack = 'shortcut_cup_black';
const shortcutIconFlowerRed = 'shortcut_flower_red';
const shortcutIconFlowerOrange = 'shortcut_flower_orange';
const shortcutIconFlowerGreen = 'shortcut_flower_green';
const shortcutIconFlowerBlue = 'shortcut_flower_blue';
const shortcutIconFlowerPurple = 'shortcut_flower_purple';
const shortcutIconFlowerBrown = 'shortcut_flower_brown';
const shortcutIconFlowerPink = 'shortcut_flower_pink';
const shortcutIconFlowerAmber = 'shortcut_flower_amber';
const shortcutIconFlowerTeal = 'shortcut_flower_teal';
const shortcutIconFlowerCyan = 'shortcut_flower_cyan';
const shortcutIconFlowerLavender = 'shortcut_flower_lavender';
const shortcutIconFlowerBlack = 'shortcut_flower_black';
