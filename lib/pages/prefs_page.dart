...
class _PrefsWidgetState extends State<PrefsWidget> {
  ...
  Widget get _showExtraSetting => Selector<AppProvider, bool>(
        ...
        builder: (context, useBrewRatios, child) {
          return settingSwitch(
            ...
            onChanged: (bool newValue) {
              Provider.of<AppProvider>(context, listen: false).showExtra =
                  newValue;
            },
          );
        },
  ...
  Widget get _stackedViewSetting => settingSwitch(
        ...
        onChanged: (bool newValue) {
          Provider.of<AppProvider>(context, listen: false).stackedView =
              newValue;
        },
      );
  ...
  Widget get _appLanguageSetting => settingList(
        ...
        selectedItem:
            languageLabel(Provider.of<AppProvider>(context).appLanguage),
